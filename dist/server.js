...
app.get("/", (req, res) => {
  const json = {
    status: "ok",
    message: "Sistema Compras em Produ\xE7\xE3o!"
  };
  res.json(json);
});
...
var port = process.env.PORT || 63021;
if (process.env.NODE_ENV !== "dev") {
  const options = {
    key: import_fs.default.readFileSync("/etc/ssl/private/lm/private.key"),
    cert: import_fs.default.readFileSync("/etc/ssl/certs/lm/certificate.crt"),
    ca: import_fs.default.readFileSync("/etc/ssl/certs/lm/ca-bundle.crt")
  };
